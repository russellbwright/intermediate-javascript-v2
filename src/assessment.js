...
function context1(x,y){
  return sum.call(this.contextObj, x, y)
}
...
return sum.apply(this.contextObj, params)
}
...
function context3(){
  return sum.bind(this.contextObj)
}
...
function CoinToss(){
  this.results = [];
  this.flip = function(){
    return this.results.push("tails")
  }
...
function compareValues(parm1, parm2){
  if(parm1 === parm2){
      return "Exact match"
  } else if(parm1 == parm2) {
